                    ...
                    <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                            <div class="text-gray-600">
                                <p class="font-medium text-lg">{{ $title ?? "Tambah List Sampah" }}</p>
                                <p>{{ $description ?? "Halo" }}</p>
                            </div>

                            @csrf
                            <form action="{{ asset('redeemProduct.store') }}">
                                <div class="lg:col-span-2">
                                    <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-5">

                                        <div class="md:col-span-5">
                                            <label for="full_name">Nama Produk</label>
                                        ...
                                        <div class="md:col-span-5">
                                            <label for="full_name">Stok</label>
                                            <input type="number" name="total_quantity"
                                                class="h-10 border mt-1 rounded px-4 w-full bg-gray-50" value="" />
                                        </div>
