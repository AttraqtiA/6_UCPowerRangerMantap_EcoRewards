<footer class="bg-white">
    <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
        <div class="md:flex md:justify-between">
          <div class="mb-6 md:mb-0">
              <a href="#" class="flex items-center">
                  <img src="/images/ecoreward_logo.png" class="h-8 me-3" alt="EcoRewards Logo" />
                  <img src="/images/ecoreward_title.png" class="h-8 me-3" alt="EcoRewards Title" />
              </a>
          </div>
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center ">© 2024 <a href="/" class="hover:underline">EcoRewards™</a>. All Rights Reserved.
          </span>
