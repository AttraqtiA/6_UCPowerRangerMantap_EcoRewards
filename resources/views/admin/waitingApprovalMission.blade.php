                    ...
                    <table class="w-full text-sm text-center text-gray-500">
                        ...
                        <tbody>
                            <tr class="border-b hover:bg-gray-100">
                                ...
                                <td class="px-4 h-36 w-36 py-3 font-medium text-gray-900 whitespace-nowrap">
                                    <img src="{{ asset('image/babi.jpg') }}" alt="">
                                </td>
                            ...
                            <tr class="border-b hover:bg-gray-100">
                                ...
                                <td class="px-4 h-36 w-36 py-3 font-medium text-gray-900 whitespace-nowrap">
                                    <img class="" src="{{ asset('image/babi.jpg') }}" alt="">
                                </td>
